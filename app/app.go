...
import (
	...
	vnicmodulekeeper "vnic/x/vnic/keeper"

	kycante "vnic/x/kyc/ante"
	kyckeeper "vnic/x/kyc/keeper"
	_ "vnic/x/kyc/module"
)
...
type App struct {
	*runtime.App
	...
	VnicKeeper vnicmodulekeeper.Keeper
...
func New(
	...
	anteHandler := kycante.NewAnteHandler(kycante.HandlerOptions{
